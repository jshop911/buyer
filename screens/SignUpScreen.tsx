      ...
      app
        ...
        .then((response) => {
          ...
          const data = {
            ...
            // ginalaw ko
            // dateCreated: Timestamp.fromDate(new Date("December 10, 1815")),
          ...
          const usersRef = app.firestore().collection("userBuyer");
          usersRef
            .doc(uid)
            .set(data)
            .then(() => {
              navigation.navigate("Home");
              Alert.alert("Welcome to Jshop! Have a good day! 😀");
            })
            .catch((error) => {
        ...
        <View style={tw`flex-1 bg-[#e0e0e0]`}>
          ...
          {!!value.error && (
            <View style={tw`bg-red-800`}>
              <Text style={tw`p-3 text-gray-50`}>{value.error}</Text>
            </View>
          )}
